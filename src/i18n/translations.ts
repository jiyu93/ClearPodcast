...
const english = {
  ...
  device: {
    ...
    gpuMode: "GPU Mode",
    cpuMode: "CPU Mode",
    switchToGpuMode: "Switch to GPU mode",
    switchToCpuMode: "Switch to CPU mode",
...
const chinese: Translation = {
  ...
  device: {
    ...
    gpuMode: "GPU 模式",
    cpuMode: "CPU 模式",
    switchToGpuMode: "切换到 GPU 模式",
    switchToCpuMode: "切换到 CPU 模式",
...
const japanese: Translation = {
  ...
  device: {
    ...
    gpuMode: "GPU モード",
    cpuMode: "CPU モード",
    switchToGpuMode: "GPU モードに切り替える",
    switchToCpuMode: "CPU モードに切り替える",
...
const korean: Translation = {
  ...
  device: {
    ...
    gpuMode: "GPU 모드",
    cpuMode: "CPU 모드",
    switchToGpuMode: "GPU 모드로 전환",
    switchToCpuMode: "CPU 모드로 전환",
