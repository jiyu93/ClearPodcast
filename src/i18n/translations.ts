...
const english = {
  ...
  audio: {
    ...
    skipBackAriaLabel: (title: string) => `Skip back ${title} 5 seconds`,
    skipForwardAriaLabel: (title: string) => `Skip forward ${title} 5 seconds`,
    ...
    back5Title: "Back 5 seconds",
    forward5Title: "Forward 5 seconds",
    playTitle: "Play",
    pauseTitle: "Pause",
    muteTitle: "Mute",
    unmuteTitle: "Unmute",
  ...
  model: {
    title: "Enhancement Model Parameters",
    reset: "Reset",
    solver: "Solver",
...
const japanese: Translation = {
  ...
  audio: {
    ...
    skipBackAriaLabel: (title) => `${title}を 5 秒戻す`,
    skipForwardAriaLabel: (title) => `${title}を 5 秒進める`,
...
const korean: Translation = {
  ...
  audio: {
    ...
    skipBackAriaLabel: (title) => `${title} 5초 뒤로`,
    skipForwardAriaLabel: (title) => `${title} 5초 앞으로`,
