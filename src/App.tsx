...
export default function App() {
  ...
  const hasCustomTitleBar =
    /Win/i.test(navigator.platform) && "__TAURI_INTERNALS__" in window;
  ...
  return (
    <main className={`app-root ${hasCustomTitleBar ? "custom-titlebar" : ""}`}>
      {hasCustomTitleBar ? <AppTitleBar /> : null}
